...
# Load the pre-trained BART fine-tuned model and tokenizer
...
def summarize_text(text, max_length=150, min_length=40, num_beams=4):
    ...
    # Generate summary
    summary_ids = ft_model.generate(inputs, max_length=max_length, min_length=min_length, num_beams=num_beams, length_penalty=2.0, early_stopping=False)
