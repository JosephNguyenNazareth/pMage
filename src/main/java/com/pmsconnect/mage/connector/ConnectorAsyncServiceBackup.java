...
@Service
public class ConnectorAsyncServiceBackup {
    private final ConnectorRepository connectorRepository;

    @Autowired
    public ConnectorAsyncServiceBackup(ConnectorRepository mageRepository) {
...
//            this.retrieveAllCommit(connector, monitoringMessAll);
    ...
    public List<Dictionary<String, String>> getAllTrigger(String connectorId) {
        ...
        return appConfig.getLatestTrigger(true, connector.getActionLinkage(), connector.getBridge());
    }
    ...
    public void retrieveLatestTrigger(Connector connector, StringBuilder monitoringMess) {
        ...
        List<Dictionary<String, String>> actionTriggeredList = connector.getAppConfig().getLatestTrigger(false, connector.getActionLinkage(), connector.getBridge());
...
//            return "revert";
        ...
        boolean found = false;
        for (ActionEvent actionEvent : connector.getActionLinkage()) {
            if (triggeredActionTask.contains(actionEvent.getContextInfo())) {
                found = true;
